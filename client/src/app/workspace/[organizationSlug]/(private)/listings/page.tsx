      ...
      <Card className="p-6 md:p-8 bg-surface border border-border rounded-2xl">
        <div className="flex items-center gap-3 mb-4 select-none">
          ...
          <div>
            <Typography type="h3" className="font-bold text-foreground">
              Service Listings & Packages
            </Typography>
            <Typography type="body-xs" className="text-muted">
              Configure and audit developer-verified credentials listings, travel packages, and service portals.
            </Typography>
          </div>
        </div>
        ...
        <div className="mt-8 border border-dashed border-border/80 rounded-2xl p-12 text-center select-none">
          ...
          <Typography type="body-xs" className="text-muted max-w-md mx-auto mb-6">
            The Listings module is currently undergoing audit verification. Service and credentials listings will become active in the next rollout phase.
          </Typography>
          <Button
