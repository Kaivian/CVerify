    ...
    <div className="flex flex-col h-full rounded-2xl border border-border bg-surface shadow-2xl overflow-hidden font-mono text-foreground">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-surface-secondary border-b border-border text-xs">
        <div className="flex items-center gap-3">
          ...
          {/* Status Badge */}
          <span
            className={`px-2 py-0.5 rounded-full text-[10px] font-semibold tracking-wider flex items-center gap-1.5 ${isPaused
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-2.5 bg-surface-tertiary/40 border-b border-border text-xs">
        {/* Search Bar */}
        <div className="relative flex-1 min-w-60 max-w-md flex items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <Dropdown>
            ...
            <Dropdown.Popover placement="bottom start" className="bg-surface border border-border shadow-xl rounded-xl p-1.5 min-w-40 z-50 font-outfit">
      ...
      <div
        ref={containerRef}
        className="flex-1 overflow-y-auto p-3 space-y-1 text-xs select-text font-mono min-h-105 bg-background text-foreground"
      >
        {filteredLogs.length === 0 ? (
          ...
          filteredLogs.map((log, index) => {
            ...
            return (
              <div
                key={log.id}
                className={`group flex flex-col rounded-md border px-3 py-2 transition-all ${log.isPinned
