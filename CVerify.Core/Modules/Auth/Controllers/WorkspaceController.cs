...
public class WorkspaceController : ControllerBase
{
    ...
    public async Task<IActionResult> GetWorkspaceDetails(string organizationSlug)
    {
        ...
        if (isBusiness)
        {
            ...
            var businessRole = OrganizationRole.OWNER;
            var businessPermissions = OrganizationPermissions.GetPermissionsForRole(businessRole);
        ...
        if (Enum.TryParse<OrganizationRole>(membership.Role, out var orgRole))
        {
            permissions = OrganizationPermissions.GetPermissionsForRole(orgRole);
        }
